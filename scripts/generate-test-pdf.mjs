...
// Page 1: Title + outer rectangle + circle + triangle
{
  ...
  // Triangle (3 lines)
  p.drawLine({ start: { x: 200, y: 420 }, end: { x: 380, y: 420 }, color: rgb(0.5, 0.5, 0.5), thickness: 1 })
  p.drawLine({ start: { x: 200, y: 420 }, end: { x: 290, y: 380 }, color: rgb(0.5, 0.5, 0.5), thickness: 1 })
  p.drawLine({ start: { x: 380, y: 420 }, end: { x: 290, y: 380 }, color: rgb(0.5, 0.5, 0.5), thickness: 1 })
}
...
// Page 2: Dimensions & tolerances
{
  ...
  p.drawLine({ start: { x: 100, y: 600 }, end: { x: 500, y: 600 }, color: rgb(0, 0, 0), thickness: 1 })
  p.drawLine({ start: { x: 100, y: 595 }, end: { x: 100, y: 605 }, color: rgb(0, 0, 0), thickness: 1 })
  p.drawLine({ start: { x: 500, y: 595 }, end: { x: 500, y: 605 }, color: rgb(0, 0, 0), thickness: 1 })
  p.drawText('400 +/-0.05', { x: 260, y: 615, size: 11, font: fontRegular })
  // Vertical dimension
  p.drawLine({ start: { x: 80, y: 200 }, end: { x: 80, y: 600 }, color: rgb(0, 0, 0), thickness: 1 })
  p.drawLine({ start: { x: 75, y: 200 }, end: { x: 85, y: 200 }, color: rgb(0, 0, 0), thickness: 1 })
  p.drawLine({ start: { x: 75, y: 600 }, end: { x: 85, y: 600 }, color: rgb(0, 0, 0), thickness: 1 })
