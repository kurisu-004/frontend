...
export function formatCustomerOptionLabel(c: { name: string; parent_name: string | null }): string {
...
export function useAssemblyDetail(assemblyId: Ref<string>): UseAssemblyDetailReturn {
