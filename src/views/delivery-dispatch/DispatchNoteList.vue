    ...
    <div v-loading="loading" class="content">
      ...
      <div v-else class="note-list">
        ...
        >
          ...
          <div v-if="expandedId === n.id" v-loading="states[n.id]?.loading" class="note-body">
            <div
            ...
            >
              ...
              <div class="line-main">
                <div class="line-top">
                  <span class="line-serial">{{
                    item.serial_no || item.drawing_no || item.id
                  }}</span>
...
import { ArrowDown, CircleCheck, Clock, Refresh, Van } from '@element-plus/icons-vue';
...
.line-item.is-scanned .scan-mark {
  color: #67c23a;
}
.line-main {
  flex: 1;
