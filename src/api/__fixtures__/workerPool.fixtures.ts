...
export const FIXTURE_HELD_BY_WORKER: Record<string, WorkOrderCard[]> = {
  '1900000000001': [
    {
      ...
      planned_delivery_date: '2026-09-08',
      is_urgent: false,
      version: 1,
      customer: null,
      applicant: null,
  ...
  '1900000000003': [
    {
      batch_id: '3000000000020',
      batch_no: 'B2026-08-020',
      part_id: '4000000000020',
      drawing_no: 'DWG-C001',
      part_name: '垫片',
      quantity: 10,
      serial_no: 'SN-100',
    ...
    {
      batch_id: '3000000000021',
      batch_no: 'B2026-08-021',
      part_id: '4000000000021',
      drawing_no: 'DWG-C002',
      part_name: '螺栓',
      quantity: 50,
      serial_no: null,
      system_delivery_date: '2026-09-15',
