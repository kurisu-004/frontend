...
| ------------------------------------- | ------------------------- | ------------------------------------------------- | ------------------------------ | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/login`                              | Login                     | `views/auth/LoginView.vue`                        | —                              | false            | 全屏独立路由，不在 MainLayout 内                                                                                                                                                                                                          |
| `/dashboard`                          | Dashboard                 | `views/dashboard/DashboardView.vue`               | `home`                         | true             | 默认重定向目标                                                                                                                                                                                                                            |
| `/parts`                              | PartsList                 | `views/parts/list/PartsList.vue`                  | `parts_list`                   | true             | 订单管理根                                                                                                                                                                                                                                |
| `/parts/new`                          | PartsNew                  | `views/parts/new/PartBatchNew.vue`                | `parts_new`                    | true             | 批量新建                                                                                                                                                                                                                                  |
| `/parts/:id`                          | PartsDetail               | `views/parts/detail/PartDetail.vue`               | —                              | true             | 复用父级 `parts_list` 权限（matched 链）                                                                                                                                                                                                  |
...
| `/workers`                            | WorkerList                | `views/workers/WorkerList.vue`                    | `workers_list`                 | true             | 工人一览                                                                                                                                                                                                                                  |
...
| `/production/process-design`          | ProcessDesign             | `views/production/ProcessDesignView.vue`          | `part_process_chain`           | true             | 2026-09-11 工序制定；2026-09-14 menuCode 改名 `process_design_list` → `part_process_chain`；2026-09-16 PR-3 接入 20706 BIZ_PROCESS_CHAIN_REQUIRED 兜底（详 [`docs/03-modules/production/README.md`](../03-modules/production/README.md)） |
